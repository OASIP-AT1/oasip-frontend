...
// const fileDownload = window.URL.createObjectURL(window.Blob([files.value]));
</script>

<template>
    <div v-if="isLoading" class="modal-show">
        <div class="half-circle-spinner absolute top-1/2 left-1/2">
        ...
        >
            ...
            <div class="grid grid-cols-2 justify-center pt-6 gap-5">
                ...
                <div>
                    <label for="Duration"
                        >Duration
                        <span class="auto-fill">(minutes)</span></label
                    >
                    <div class="py-2">
                        <input
                            class="input input-md border-slate-400 w-full max-w-xs bg-slate-100"
            ...
            <div>
                <label for="File"
                    >Attachments
                    <span class="auto-fill">(optional)</span></label
                >
                <div class="py-2">
                    <div>
                        <label
                    ...
                    <div v-if="isMaxsize" class="text-red-600 mt-3">
                        ** File is too large, The file should not exceed 10 MB.
                    </div>
                    <div
...
.half-circle-spinner .circle.circle-1 {
    border-top-color: #f99952;
    animation: half-circle-spinner-animation 1s infinite;
}

.half-circle-spinner .circle.circle-2 {
    border-bottom-color: #f99952;
